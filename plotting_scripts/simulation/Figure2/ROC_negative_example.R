...
library(RnBeads)
library(pROC)
folder.path <- "/TL/deep/projects/work/mscherer/projects/heterogeneity/simulation/results/correct_simulation/negative_example/results_pipeline/"
plot.path <- "/TL/deep/projects/work/mscherer/projects/heterogeneity/simulation/results/analysis/correct_simulation/negative_example/pdfs/"
roc.path <- "/TL/deep/projects/work/mscherer/projects/heterogeneity/simulation/results/analysis/correct_simulation/negative_example/roc/"
plot.type <- "pdf"
