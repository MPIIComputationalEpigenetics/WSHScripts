#####################################################################################################
#' methylation_switch.R
#----------------------------------------------------------------------------------------------------
#' This script produces figures like Figure 3B in the paper: A positional view of the ISH scores
#' together with the methylation level for a region that changes its methylation state.
