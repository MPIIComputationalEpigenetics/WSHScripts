...
#####################################################################################################
#' simulate_SNPs.py
#' This script describes the pipeline used to model possible dependencies of the ISH scores single
#' nucleotide polymorphism occurring in the reads.
#####################################################################################################
...
parser.add_argument("--snps",help="number of SNPs introduced")
...
cmd = manager.config.tools.sherman + " --length " + str(manager.config.parameters.sherman.length) + " --number_of_seqs " + str(manager.config.parameters.sherman.number) + " --CG_conversion " + str(conversion_rate) + " --CH_conversion " + str(manager.config.parameters.sherman.CH) + " --genome_folder " + args.output_parent + "/" + args.sample_id + " --outfolder " + simulated + " --outname first " + " --error_rate " + str(manager.config.parameters.sherman.error_rate) + " --snps " + str(args.snps) + " --quality " + str(manager.config.parameters.sherman.quality) +" --rrbs"
