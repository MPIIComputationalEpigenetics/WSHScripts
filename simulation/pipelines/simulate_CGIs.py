...
#####################################################################################################
#' simulate_CGIs.py
#' This script describes the pipeline used to model if there are differences for the ISH scores
#' inside CpG islands in comparison to the outside, only considering the increased CpG density
