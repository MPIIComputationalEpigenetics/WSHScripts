######################################################################################################
#' compute_FDRP.R
#' This script is used to preprocess the data as input to calculate_FDRP.R
...
# Load the functions needed for the FDRP calculation
source('calculate_FDRP.R')
...
logger.start(paste("FDRP calculation for",name))
calculate.fdrps(bam,annotation,folder,name,cores=cores,window.size=51)
logger.completed()
