#' This scripts converts the output of methclone to genomic bins with the corresponding value of
#' the epipolymorphism
...
#' This function calculates the epipolymorphism from a single genomic region (line in the methclone output)
